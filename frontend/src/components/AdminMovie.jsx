...
import { fetchMovies, deleteMovie } from "../redux/Slice/movieSlice";
import {
  Card,
  CardMedia,
  CardContent,
...
const AdminMovie = () => {
  ...
  const handledelete = (e, id) => {
    ...
    alert("Movie Data Delete successfully");
                    ...
                    >
                      <Button
                        ...
                        sx={{
                          backgroundColor: "red",
                          "&:hover": {
                            backgroundColor: "darkred", // Adjust the hover color
                          },
                        }}
                        fullWidth
                      ...
                      <Link to={`/editmovies/${movie._id}`}>
                        <Button
                          variant="contained"
                          sx={{
                            backgroundColor: "green",
                            "&:hover": {
                              backgroundColor: "darkgreen", // Adjust the hover color
                            },
                          }}
                          fullWidth
                        >
